...
vivekmasonaDown.style.height="102.5%";
...
vivekmasonaDownDiv.innerHTML+="<span style='position:absolute;top:4px;left:4px;color:#ffffff;font-size:25px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2716;</span><iframe src='https://pgmoviepro.blogspot.com/' height='100%' width='100%' border='0px'></iframe><ul id='listurl'>";
...
vivekmasonaDownVidElem.innerHTML='	<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-list-details" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="#04C5B9" stroke-linecap="round" stroke-linejoin="round"> <path stroke="none" d="M0 0h24v24H0z" fill="none"/> <path d="M13 5h8" /> <path d="M13 9h5" /> <path d="M13 15h8" /> <path d="M13 19h5" /> <rect x="3" y="4" width="6" height="6" rx="1" /> <rect x="3" y="14" width="6" height="6" rx="1" /> </svg>					<br><font color=#00cdb8><b>Notification';
